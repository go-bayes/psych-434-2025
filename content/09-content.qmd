...
[Download full lab scripts 0](../laboratory/example-2/00-setup.R)
:::


::: {.callout-note-script-1}
[Download full lab scripts 1](../laboratory/example-2/01-init-data-wrangling-ex-2.R)
:::

::: {.callout-note-script-2}
[Download full lab scripts 2](../laboratory/example-2/02-data-wrangling-ex-2.R)
:::

::: {.callout-note-script-3}
[Download full lab scripts 3](../laboratory/example-2/03-analysis-ex-2.R)
:::
...
#| include: true
#| eval: false
#| file: ../laboratory/example-2/00-setup.R
```
...
```r
here_save(dat_long_prepare,          "dat_long_prepare")
...
#| include: true
#| eval: false
#| file: ../laboratory/example-2/01-init-data-wrangling-ex-2.R
...
#| include: true
#| eval: false
#| file: ../laboratory/example-2/02-data-wrangling-ex-2.R
...
Run the script in order, **eyes on three checkpoints**: the toy forest plot, smooth Qini/RATE curves, and sensible policy-tree leaves. Everything else is auto-saved for the manuscript.
...
#| include: true
#| eval: false
#| file: ../laboratory/example-2/03-analysis-ex-2.R
