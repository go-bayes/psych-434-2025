...
4. Create a new`.R` file called `02-lab.R` and provide your name, contact, data, and a brief title such as "Simulating the basic five basic causal structures in R" 
