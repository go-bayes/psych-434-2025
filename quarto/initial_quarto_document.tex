...
(\citeproc{ref-grf2024}{Tibshirani et al., 2024}) and (ii) converted
those estimates into shallow \textbf{policy trees} that practitioners
can execute (\citeproc{ref-athey2021}{Athey \& Wager, 2021a},
...
\citeproc{ref-wager2018}{Wager \& Athey, 2018}). Their \emph{p}-values
...
\pandocbounded{\includegraphics[keepaspectratio]{initial_quarto_document_files/figure-pdf/fig-policy-8-1.pdf}}

}

\caption{\label{fig-policy-8}Decision Tree: \{glued\_policy\_names\_8\}}
...
\pandocbounded{\includegraphics[keepaspectratio]{initial_quarto_document_files/figure-pdf/fig-policy-9-1.pdf}}

}

\caption{\label{fig-policy-9}Decision Tree: \{glued\_policy\_names\_9\}}
...
\pandocbounded{\includegraphics[keepaspectratio]{initial_quarto_document_files/figure-pdf/fig-policy-10-1.pdf}}

}

\caption{\label{fig-policy-10}Decision Tree:
\{glued\_policy\_names\_10\}}
...
\pandocbounded{\includegraphics[keepaspectratio]{initial_quarto_document_files/figure-pdf/fig-policy-11-1.pdf}}

}

\caption{\label{fig-policy-11}Decision Tree:
\{glued\_policy\_names\_11\}}
...
\pandocbounded{\includegraphics[keepaspectratio]{initial_quarto_document_files/figure-pdf/fig-policy-12-1.pdf}}

}

\caption{\label{fig-policy-12}Decision Tree:
\{glued\_policy\_names\_12\}}
...
0.20 (Meaning: Sense, Anxiety, Rumination, Self Esteem, Social Support,
Life Satisfaction, Meaning: Purpose, Depression, Social Belonging,
Personal Well-being Index), evidence is inconclusive.
